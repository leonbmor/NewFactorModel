...
def _run_incremental(Pxs_df: pd.DataFrame, sectors_s: pd.Series,
    ...
    if macro_cols:
        ...
        r_macro, lam_macro, r2_macro = run_factor_step_optimal_ridge(macro_cols, macro_betas, r_size, dynamic_size, macro_dt, universe, default_lambda=0.5)
    else:
    ...
    r_mom,   lam_mom,   r2_mom   = run_factor_step_optimal_ridge(['vol', 'si_composite', 'idio_mom'], {'vol': vol_df, 'si_composite': si_composite, 'idio_mom': mom_df}, r_quality, dynamic_size, calc_dates, universe, default_lambda=0.2)
