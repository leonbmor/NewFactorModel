...
def run(Pxs_df: pd.DataFrame, sectors_s: pd.Series,
    ...
    si_perp_full = orthogonalize_char_df(si_composite, prior_for_si, resid_full_quality.index)
    ...
    # Full-history version for momentum lookback chain
    vol_perp_full = orthogonalize_char_df(vol_df, prior_for_vol, resid_full_quality.index)
    # Common-dates version for stats regressions
